...
export const compoundXrefsResource = resource('pubchem://compound/{cid}/xrefs', {
  ...
  description:
    'External cross-references (CAS RN, registry IDs, PubMed) for a PubChem compound by CID (mirrors pubchem_get_compound_xrefs). Use the tool for the full set of xref types.',
